        ...
        for(Nodo n : raiz.getHijos()){
            ...
            switch (t.tipo)
            {
                ...
                case VARIABLE:
                    ...
                    {
                        if(TablasSimbolos.existeIdentificador(n.getHijos().get(0).getValue().lexema) == false)
                        {
                    ...
                    else if(TablasSimbolos.existeIdentificador(VerHijos.getHijos().get(0).getValue().lexema)==false)
                    {
                        ...
                        if(VerHijos.getHijos().size() == 2)
                        {
                            ...
                            TablasSimbolos.asignar(VerHijos.getHijos().get(0).getValue().lexema, ResOpeVar);
                        }
                    }
                    else
                    {
                ...
                case SI:
                    ...
                    if (ConCumIf)
                    {
                        for (int a = 0; a <= n.getHijos().size() - 1; a++)
                        {
                            ...
                            if(n.getHijos().get(a).getValue().tipo == Tipo_Token.ADEMAS)
                            {
                                a++;
                            }
                            else
                    ...
                    else if (n.getHijos().get(ELSE).getValue().tipo == Tipo_Token.ADEMAS)
                    {
                        Nodo Aux = new Nodo(null);
